...
(function($) {
  ...
  $('#countdown-2').countdown('2019/12/25', function(event) {
    $(this).html(
      event.strftime(
        "<div class='cd-time'><span>%w</span> <p>Week</p> </div>" +
          "<div class='cd-time'><span>%D</span> <p>Days</p> </div>" +
          "<div class='cd-time'><span>%H</span> <p>Hours</p> </div>" +
          "<div class='cd-time'><span>%M</span> <p>Minutes</p> </div>" +
          "<div class='cd-time'><span>%S</span> <p>Seconds</p> </div>"
      )
    );
  });
